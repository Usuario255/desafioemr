...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">Editar Questões</div>
                <div class="card-body">
                    <form method="POST" action="{{ url('questoes/atualizar') }}/{{ $pergunta->id }}">
                        @csrf
                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right">{{ __('Pergunta:') }}</label>
                            <div class="col-md-6">
                                <input id="descricao_pergunta" type="text" class="form-control @error('descricao_pergunta') is-invalid @enderror" name="descricao_pergunta" value="{{$pergunta->descricao_pergunta}}" required autocomplete="descricao_pergunta" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="text" name="pontuacao" class="form-control" id="pontuacao" value="{{$pergunta->pontuacao}}">
                            </div>
                        </div>
                        <div data-identifier='group-cotent-add'>
                            <div data-identifier='group-form-selects'>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="radio" name="resposta" {{$opcaoResposta->id == $resposta->id_opcao_resposta ? 'checked' : ''}} value="{{$soma}}" id="resposta">
                                        <label for="resposta"  id="opcao_resposta" data-soma="{{$soma}}">Resposta {{$soma}}</label>
                                        <textarea class="form-control" name="descricao_opcao[]" id="descricao_opcao">{{$opcaoResposta->descricao_opcao}}</textarea>
                                    </div>
